...
public class Application {
    ...
    private static void checkDatabase(UserRepository userRepository, String email) {
        ...
        try {
            ...
            if (dbUser.isPresent()) {
                ...
                System.out.println("На данный момент в базе " + allUsers.size() + " пользователей");
            }
    ...
    private static void testRegistration(UserRegistrationImpl registration, UserRepository userRepository, Scanner scanner) {
        ...
        if (user != null) {
            ...
            checkDatabase(userRepository, user.getEmail());
        } else {
